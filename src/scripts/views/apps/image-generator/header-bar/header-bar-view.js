...
import MenuBarView from '../../../../views/apps/image-generator/header-bar/menu-bar/menu-bar-view.js';
import MouseModeBarView from '../../../../views/apps/image-generator/header-bar/mouse-mode-bar/mouse-mode-bar-view.js';
import ZoomModeBarView from '../../../../views/apps/image-generator/header-bar/zoom-mode-bar/zoom-mode-bar-view.js';
import ZoomBarView from '../../../../views/apps/image-generator/header-bar/zoom-bar/zoom-bar-view.js';
import RotateBarView from '../../../../views/apps/image-generator/header-bar/rotate-bar/rotate-bar-view.js';
import GenerateBarView from '../../../../views/apps/image-generator/header-bar/generate-bar/generate-bar-view.js';
import ImageBarView from '../../../../views/apps/image-generator/header-bar/image-bar/image-bar-view.js';
...
export default HeaderBarView.extend({
	...
	onRender: function() {
		...
		//
		HeaderBarView.prototype.onRender.call(this);
