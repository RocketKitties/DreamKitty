...
import FullScreenButtonView from '../../../../../views/apps/image-generator/header-bar/image-bar/buttons/full-screen-button-view.js';
import FirstButtonView from '../../../../../views/apps/image-generator/header-bar/image-bar/buttons/first-button-view.js';
import PrevButtonView from '../../../../../views/apps/image-generator/header-bar/image-bar/buttons/prev-button-view.js';
import NextButtonView from '../../../../../views/apps/image-generator/header-bar/image-bar/buttons/next-button-view.js';
import LastButtonView from '../../../../../views/apps/image-generator/header-bar/image-bar/buttons/last-button-view.js';
import PlayButtonView from '../../../../../views/apps/image-generator/header-bar/image-bar/buttons/play-button-view.js';
