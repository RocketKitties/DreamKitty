...
import FitSizeButtonView from '../../../../../views/apps/image-generator/header-bar/zoom-mode-bar/buttons/fit-size-button-view.js';
import FitWidthButtonView from '../../../../../views/apps/image-generator/header-bar/zoom-mode-bar/buttons/fit-width-button-view.js';
import FitHeightButtonView from '../../../../../views/apps/image-generator/header-bar/zoom-mode-bar/buttons/fit-height-button-view.js';
import ActualSizeButtonView from '../../../../../views/apps/image-generator/header-bar/zoom-mode-bar/buttons/actual-size-button-view.js';
