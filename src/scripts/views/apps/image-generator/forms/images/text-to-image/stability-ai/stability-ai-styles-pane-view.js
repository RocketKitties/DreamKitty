...
import StylesPaneView from '../../../../../../../views/apps/image-generator/forms/images/text-to-image/panes/styles-pane-view.js';
...
export default StylesPaneView.extend({
	...
	initialize: function() {
		...
		// set defaults
		//
		if (!this.options.style_preset && this.options.metadata) {
			this.options.style_preset = this.options.metadata.style_preset;
		}
	},
