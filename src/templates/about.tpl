...
<div class="content">
	<p>Explore your dreams using AI image generation technology.  <%= application.name %> allows you to access a variety of image generation engines all from a single, easy to use user interface.  <%= application.name %> allows to you generate, manage, and share your images from a single location. </p>

	<div class="attention"><div class="emphasis">Your AI Images, Your Cloud</div></div>
	...
	<div class="details section">
		<div class="row">
			<div class="col-sm-6">
				...
				<ul>
					<li><b>Experiment</b> with new AI image generation technology using a variety of image generators.
					<li><b>Share your images</b> - Share AI images by link, shared folder, or email.</li>
			...
			<div class="col-sm-6">
				...
				<ul>
					<li><b>Create stunning AI generated images</b> using simple text prompts.</li></li>
					<li>Easily <b>share</b> your AI images with friends, family, or colleagues. </li>
